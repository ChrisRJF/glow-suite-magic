...
export default function CalendarPage() {
  ...
  const [selectedDay, setSelectedDay] = useState('Ma');

  return (
    <AppLayout
      title="Agenda"
      subtitle="Beheer je afspraken en vind lege plekken."
      actions={
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-base font-semibold">
              {view === 'day' ? 'Maandag 21 maart' : '17 – 22 maart 2026'}
            </h3>
            <button className="p-2 rounded-lg hover:bg-secondary transition-colors">
          ...
          <span className="text-sm text-muted-foreground">
            {view === 'day' ? `${todaysAppointments.length} afspraken` : '18 afspraken deze week'}
          </span>
        </div>
