/**
 * Canonical Auto Rebook engine (frontend).
 *
 * Single source of truth for "should this customer come back now?".
 * MUST stay byte-for-byte logic-identical to
 * `supabase/functions/_shared/autoRebook.ts` (contract test enforces this).
 *
 * Interval order:
 *   1. services.rebook_interval_days
 *   2. median of this customer's historical gaps (same service preferred)
 *   3. fallback 42 days
 *
 * No other rebook formulas may exist anywhere in the app.
 */
